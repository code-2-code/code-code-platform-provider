...
func TestNewOAuthFinalizePlanBuildsCreateProvider(t *testing.T) {
...
func TestOAuthFinalizePlanValidateExistingRejectsDifferentCredential(t *testing.T) {
	...
	err = plan.ValidateExisting(&ProviderView{
		SurfaceID:            "codex",
		ProviderCredentialID: "other-credential",
		ProviderID:           "provider-codex",
		ProviderDisplayName:  "Codex",
		VendorID:             "openai",
		Runtime:              plan.CreateProvider().GetRuntime(),
	})
	if err == nil {
